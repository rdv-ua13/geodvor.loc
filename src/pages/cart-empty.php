    ...
    <div class="cart">
        <div class="cp-heading">
            ...
            <div class="cp-heading__cta">
                <button class="btn-reset btn btn-sm btn-ghost" type="button">
                    <svg class="icon icon-fill">
                        <use href="img/sprite.svg#print"></use>
                    </svg>
                    <span class="text-content">Распечатать</span>
                </button>
            </div>
        </div>
            ...
            <div class="cp-content">
                ...
                <div class="cart-empty">
                    <a class="cart-empty__view" href="javascript:;">
                        <svg class="icon icon-fill">
                            <use href="img/cart-empty.svg#cart-empty"></use>
                        </svg>
                    </a>
                    <div class="cart-empty__descr">
                        <div class="h4">Корзина пуста</div>
                        <div class="cart-empty__subtitle">
