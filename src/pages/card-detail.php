        ...
        <div class="cp">
            <div class="cp-content">
                ...
                <div class="gap-xl">
                    ...
                    <div class="slider-out basic-slider-wrap">
                        <div class="basic-slider nav-out swiper" data-basic-slider data-basic-slider-watched>
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="card card-product card-product--watched card-product--watched-sm">
                ...
                <div class="gap-lg">
                    ...
                    <br>
                    <br>
                    Спанбонд черный 80 мкм применяют для защиты насаждений от заморозков ранней весной. Он поглощает энергию солнечных лучей и передает ее грунту, тем самым защищая его от переохлаждения. Полотно также препятствует интенсивному испарению влаги, выветриванию и прорастанию сорняков. Все вместе это создает благоприятные условия для роста растений и достижения максимальной урожайности.
                    <br>
                    <br>
                    Наша компания предлагает организациям и частным лицам купить спанбонд 80 мкм на максимально выгодных условиях:
                    <br>
                    <br>
                    <ul class="list-reset cp-list cp-list-default">
                        <li>минимальная цена;</li>
                        <li>гарантия надлежащего качества материала;</li>
                        <li>розничная и оптовая продажа;</li>
                        <li>оперативная доставка;</li>
                        <li>организация плановых поставок.</li>
                    </ul>
                    <br>
                    <br>
                    Если нужна консультация или хотите оформить заказ — звоните в рабочие часы. Оставить заявку на сайте можно в любое время.
                </div>
                <div class="gap-xl">
                    <div class="gap-sm-plus">
